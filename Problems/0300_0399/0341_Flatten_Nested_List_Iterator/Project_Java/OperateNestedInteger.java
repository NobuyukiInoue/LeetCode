...
public class OperateNestedInteger {
    public List<NestedInteger> createListNestedInteger(String flds_str) {
        ...
        //  System.out.println("flds_str = " + flds_str);
            if (flds_str.charAt(0) == '[') {
                ...
                if (pos1 == -1 && pos2 == -1) {
                    ...
                    ni.add(new NestedInteger(Integer.parseInt(flds_str.substring(0, pos))));
                    flds_str = flds_str.substring(pos + 1);
                } else if (pos1 >= 0) {
    ...
    public NestedInteger createNestedInteger(String flds_str) {
        ...
        //  System.out.println("flds_str = " + flds_str);
            ...
            if (flds_str.charAt(0) == '[') {
                ...
                if (pos1 == -1 && pos2 == -1) {
                    ...
                    ni.add(new NestedInteger(Integer.parseInt(flds_str.substring(0, pos1))));
                    flds_str = flds_str.substring(pos1 + 1);
                } else {
                    System.out.println("createNestedInteger() Error.");
                }
